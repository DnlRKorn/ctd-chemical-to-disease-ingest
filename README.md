# ctd-chemical-to-disease-ingest

| [Documentation](https://DnlRKorn.github.io/ctd-chemical-to-disease-ingest) |
...
```bash
cd ctd-chemical-to-disease-ingest
make install
make test
```
...
Download the data for the ctd_chemical_to_disease_ingest transform:

```bash
poetry run ctd_chemical_to_disease_ingest download
```

To run the Koza transform for ctd-chemical-to-disease-ingest:

```bash
poetry run ctd_chemical_to_disease_ingest transform
```

To see available options:

```bash
poetry run ctd_chemical_to_disease_ingest download --help
# or
poetry run ctd_chemical_to_disease_ingest transform --help
```
